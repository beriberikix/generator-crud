...
module.exports = function(grunt) {
  ...
  grunt.registerTask('build', 'Build your blog.', function() {
    ...
    var ignoredWords = ['the', 'couldn\'t', 'you\'re', 'you\'ve', 'just', 'something', 'some', 'thing', 'um', 'ahh', 'ah', 'uh', 'if', 'out', 'at', 'no', 'with', 'had', 'got', 'have', 'for', 'it\'s', 'that', 'that\'s', 'from', 'in', 'a', 'of', 'them', 'you', 'his', 'her', 'their', 'there', 'how', 'what', 'why', 'who', 'when', 'i', 'went', 'to', 'they', 'you\'ll', 'welcome', 'are'];
    ...
    grunt.file.recurse('posts', function(post, root, sub, fileName) {
      ...
      post = grunt.file.read(post).toLowerCase().trim().replace(/\s+/gm, ' ');
    ...
    words = grunt.util._.chain(words).flatten().reject(function(word) {
      return !word;
    }).value();
